...
const Footer = () => {
  return (
    <footer className="w-full bg-white text-gray-600 mt-20 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      <div className="flex flex-col sm:flex-row gap-1 justify-center items-center sm:justify-between">
        <div className="mt-1">
          <span>© 2024 quick-sign All rights reserved</span>
        </div>
