...
import {Swap,CodesandboxLogo,Eye} from "phosphor-react"
    ...
    return (
        <div className="   mx-auto h-[98vh] font-poppins flex flex-col gap-8  justify-center items-center">
          ...
          <div className=" flex flex-col justify-center items-center">
              ...
              <h1 className="text-2xl sm:text-3xl mt-2 font-bold font-mono text-white">Register here!</h1>
          </div>
          <form className="flex flex-col  w-[100%] sm:w-[380px] mx-auto  gap-4 mt-5 loginsection" onSubmit={(e) => { e.preventDefault(); handleSignUp(e); }} method="post">
              <div className="relative  bg-white rounded-lg w-full">
                <input
                    ...
                    <label
                     ...
                     >Name <span className="text-red-500 font-bold text-lg">*</span></label>
                </div>
              <div className="relative  bg-white rounded-lg w-full">
                <input
                    type="email"
                    ...
                    <label
                       htmlFor="email"
                       className="pointer-events-none absolute left-0 top-0 origin-[0_0] border border-solid border-transparent px-3 py-4 text-neutral-500 transition-[opacity,_transform] duration-200 ease-linear peer-focus:-translate-y-2 peer-focus:translate-x-[0.15rem] peer-focus:scale-[0.85] peer-focus:text-primary peer-[:not(:placeholder-shown)]:-translate-y-2 peer-[:not(:placeholder-shown)]:translate-x-[0.15rem] peer-[:not(:placeholder-shown)]:scale-[0.85] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
                     >Email address <span className="text-red-500 font-bold text-lg">*</span></label>
                </div>
                <div className="relative rounded-lg bg-white w-full">
                  <input
                   ...
                   <label
                     htmlFor="password"
                     className="pointer-events-none absolute left-0 top-0 origin-[0_0] border border-solid border-transparent px-3 py-4 text-neutral-500 transition-[opacity,_transform] duration-200 ease-linear peer-focus:-translate-y-2 peer-focus:translate-x-[0.15rem] peer-focus:scale-[0.85] peer-focus:text-primary peer-[:not(:placeholder-shown)]:-translate-y-2 peer-[:not(:placeholder-shown)]:translate-x-[0.15rem] peer-[:not(:placeholder-shown)]:scale-[0.85] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
                     >Password <span className="text-red-500 font-bold text-lg">*</span></label
                   >
                  <Eye
                ...
                <div className="checkboxfield flex items-center">
                    ...
                    <label htmlFor="cb" className="text-white ml-2 cursor-pointer">
                ...
                <div className="  text-center  ">
                  <span className="msg text-white">
                    Already a Member?{" "}
                    {
                      redirect_url?(<a href={`/auth/login?redirect_url=${redirect_url}`} className="underline  font-bold text-blue-200">Login</a>)
                      :(<a href={`/auth/login`} className="underline  font-bold text-blue-200">login</a>)
                    }
                  </span>
                </div>   
            </form>
