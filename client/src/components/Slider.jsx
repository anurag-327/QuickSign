...
import { Files, Key, PlusCircle, SignOut, SquaresFour, TestTube, UserSquare } from 'phosphor-react'
...
const Slider = ({tab}) => {
  ...
  return (
    <div className='w-full md:w-[350px] flex flex-col gap-4 text-white  items-center py-4 px-3 bg-#181818] '>
        ...
        <div className='flex flex-col   border-gray-500 py-4 gap-2 text-gray-400 text-start w-full px-2'>
           <a className={`hover:bg-[#333] ${tab=="applications"&&"bg-[#333]"} flex gap-2 rounded-md px-2 items-center py-2`} href="/dashboard?tab=applications"><SquaresFour size={25} color="#ffffff" weight="light" />OAuth Apps</a>
