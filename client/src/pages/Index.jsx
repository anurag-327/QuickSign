        ...
        <div className="sm:w-[50%] w-[95%]   flex flex-col gap-10  justify-center items-center">
          <div className=" flex flex-col justify-center items-center">
            <CodesandboxLogo
              ...
              weight="light"
            />
            <h2 className="text-2xl sm:text-3xl text-center text-white font-bold  mt-3">
              {" "}
              QuickSign
            </h2>
          ...
          <div className="flex flex-col gap-5 w-[100%] items-center">
            <a
              className="bg-violet-500 w-[80%] sm:w-[50%] no-underline hover:shadow-xl hover:scale-105 transform translate duration-300 text-center font-bold text-white p-3 rounded-lg"
              href="/auth/login"
            >
              Sign In to Continue
            </a>
