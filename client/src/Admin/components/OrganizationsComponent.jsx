...
const OrganizationsComponent = () => {
  ...
  useContext(() => {}, [organizations]);
  return (
    <div className="w-[60%] md:w-[70%] sm:w-[95%] mx-auto ">
      <div className="text-2xl w-full mx-auto text-center sm:mt-20 mt-10 font-bold ">
        ...
        <table className="w-full rounded-lg text-gray-200 text-lg mt-5 mb-10  bg-[#181818] border-gray-500 border divide-y-2 divide-gray-500">
          ...
          <tbody className="divide-y text-center divide-gray-500 ">
            {organizations.map((data, index) => (
              <tr>
                <td className="px-4 py-2 font-medium  border whitespace-pre-wrap">
                  {data.name}
                </td>
                <td className="px-4 py-2 sm:hidden border whitespace-pre-wrap">
                  {data.type}
                </td>
                <td className="px-4 py-2  border whitespace-pre-wrap">
                  {data.status}
                </td>
                <td className="px-4 py-2 text-blue-400 underline border whitespace-pre-wrap">
